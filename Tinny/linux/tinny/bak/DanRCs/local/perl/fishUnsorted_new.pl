...
# Revision 1.2  2006/05/10 01:10:43  dxl
# add more help info.
#
...
my $usage = "\nUsage:\n".
            " $0 \n".
            "     -b <bait_file> \n".
            "     -c <bait_col_spec> (start from 1, e.g. 1-6,8-19)\n".
            "     -s <pond_col_spec> (start from 1, e.g. 3 or 3-5,10-12)\n".
            "     [options] \n".
            "     <pond_file> [ > fishfile ]\n".
            " options:\n".
            "    -h: show this message\n".
            ...
            "\n".
            " $0 can use multiple columns in both bait and pond files. Uses the length of <bait_col_spec> determine how many columns to use from the pond if only one column number is specified in <pond_col_spec>, otherwise, the number of columns should match between bait and pond\n".
            " You may use gzipped or ungzipped files at will.\n".
            "\n".
            " NOTE: to use STDIN for the pond, you must give the <pond_file> name \"-\"\n"
          . "\n".
            "Example:\n".
            "Fish using column 3-8,21-25 in pond\n".
            "$0 -b bait.dat -c1-6,11-15 -s3-8,21-25 pond.dat\n".
            "Fish using column 1-11 in pond\n".
            "$0 -b bait.dat -c1-6,11-15 -s1 pond.dat\n\n";
