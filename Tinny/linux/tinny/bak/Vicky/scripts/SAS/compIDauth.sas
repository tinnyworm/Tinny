...
filename afile pipe "gunzip -c authsample0204_46.gz";
*filename ofile pipe "gzip >redo_frads_authwhole.gz";
filename outfile pipe "gzip >sixaccoutauth.gz";
...
*file ofile;
*put fraudsID authdate fraudstype fraudsdate authtime amount;
run;
...
if fraudsID='403769BJWCBBBMWM' or
 ...
 file outfile;
 put fraudsID authdate authtime amount;
 run;
