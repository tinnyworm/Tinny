...
/* Type */
proc chart data=cardu;
  hbar C048 /type=percent missing nozeros;
...
/* Number of cards */
proc chart data=cardu;
  hbar C088 /type=percent missing nozeros;
  title 'A025A. Number of Cards';
run;

proc means n nmiss min max median std
  data=cardu;
  var C088N;
  title 'A025B. Statistics of number of cards';
run;
...
/* Portfolio ID */
proc chart data=cardu;
  hbar C187 /type=percent missing nozeros;
  title 'A035. Card Portfolio ID';
run;
