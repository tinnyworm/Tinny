...
data auth;
  ...
  input
    ...
    @164 C164       $1.       /* Filler */
    @165 C165       $22.      /* Merchant name (name) */
    @188 C188       $13.      /* Merchant name (city) */
    @202 C202       $3.       /* Merchant name (state/cntry) */
  ;
...
proc chart
  data=auth;
  hbar C165_mis /type=percent missing;
  title 'A038. Merchant-name (name)';
run;

proc chart
  data=auth;
  hbar C188_mis /type=percent missing;
