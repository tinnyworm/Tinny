/* GDCHART 0.94b  GDCHART.C  12 Nov 1998 */
...
static int qcmpr( struct YS *a, struct YS *b )
	{ if (a->y2 < b->y2) return 1; if (a->y2 > b->y2) return -1; return 0; }
void
...
static int barcmpr( struct BS *a, struct BS *b )
	{ if (a->y2 < b->y2) return -1; else if (a->y2 > b->y2) return 1; return 0; }
