...
# varlist is the superset
#
# the special types are:
# numeric: mean, std, min, max will be calculated
# amount : will be round to 10 when < 500, to 50 when 500<x<5000, to 100
#          when larger
# categorical: will be listed by frequency
# 
# one field can belong to multiple types
