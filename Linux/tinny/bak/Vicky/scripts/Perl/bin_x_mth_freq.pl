...
## generate the BIN by month frequency 
## yxc 01/30/04

$usage = "\nUsage: bin_x_mth_freq.pl [ -f filename,BIN column start,Month column start:<filename,BIN column start,Month column start> ]"
         . "                         [ -h ] \n"
         . " where:\n"
         . "    -h    :   show this message\n\n"
	 . " Note : 1) Please do not leave any blank within the option content. \n\n"
	 . "example: bin_x_mth_freq.pl  -f auths.dat.gz,1,20:cards.dat.gz,1,91 \n\n";
