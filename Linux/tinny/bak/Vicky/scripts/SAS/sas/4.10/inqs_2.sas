...
%blanks(C035,C035,ani);
%catvar(C051,C051,conn,$1.,%str( ));
%catvar(C052,C052,resp,$1.,%str( ));
%catvar(C053,C053,fraud,$blank.,%str( ));
...
****** FIELD SPECIFIC **********;
	...
	%rtf(1,b=0);
 	...
 	%rtf(4, 2 4 4 1, b=1, h=a, v=a);
	   ...
	   put &bl "INQ-ANI-NUMBER" &cl "&ani"  &cc &cl &e;
	   put &bl "INQ-CONNECT-MODE" &cl "&conn"  &cc &cl &e;
	   put &bl "INQ-RESPONSE-MODE" &cl "&resp"  &cc &cl &e;
	   put &bl "INQ-FRAUD-TRX" &cl "&fraud"  &cc &cl &e;
