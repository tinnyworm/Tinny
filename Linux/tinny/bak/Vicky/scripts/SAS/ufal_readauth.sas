...
input
     ...
     @147 CSHBKAMT      $13.      /* CASH BACK AMOUNT */
     @160 FALSCORE      $4.       /* FALCON SCORE */
;
...
n_cshbk = cshbkamt*1.0;
cshbkbin = put(n_cshbk, am1_bin.);
...
run;
proc chart data=xyz;
     hbar cshbkbin /type=percent missing;
     title 'Cash Back Amount';
run;
proc chart data=xyz;
     hbar n_falscr /type=percent missing;
     title 'Falcon Score';
run;
